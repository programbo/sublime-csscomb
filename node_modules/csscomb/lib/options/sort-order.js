module.exports = {
    ...
    process: function(nodeType, node) {
        ...
        for (i = 0, l = node.length; i < l; i++) {
            ...
            // Look for includes:
            if (node[i][0] === 'include') {
                // Support order for mixin names in you config file such as
                // '$include respond' so you can put that at the end of your sort order for example
                var mixinName = node[i][3][1][1];
